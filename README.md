...
One base image carries the AI coding CLIs (Claude Code, Codex, Gemini), Claude Desktop, Google
Chrome, Node 22 LTS and CLI essentials. Three dev-kit images build on it:

| Image | Adds |
|-------|------|
| [`localhost/ai-base`](base/README.md) | Claude/Codex/Gemini CLIs, Claude Desktop, Chrome, Meld, Lite XL, WezTerm, rtk, agent-browser, Node 22 LTS, git, build tools |
